            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-10">
                ...
                <table className="w-full text-sm text-left    text-white dark:text-white">
                  <thead
                    className="text-xs text-green-500 uppercase bg-gray-200 "
                    style={{
                      backgroundColor: mode === "dark" ? "rgb(46 49 55)" : "",
                      color: mode === "dark" ? "white" : "",
                    }}
              ...
              <div className="relative overflow-x-auto mb-10">
                ...
                <center className="m-4 rounded-lg">
                  <iframe
                    ...
                    width="640px"
                    height="480px"
                    src="https://forms.office.com/Pages/AnalysisPage.aspx?AnalyzerToken=BuKF7hOZfJqrgzTIEfQKtrZm9etSWxh0&id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAANAATbDxhpUN0FJTkhOTzNUSTNJQVNNOTBTMzZaTjNPUC4u"
                    frameBorder={0}
                    marginWidth={0}
                    marginHeight={0}
                    style={{
