        ...
        <section id="Index" className="text-white  container inset-0 ">
          <table className=" border-collapse border-2 border-slate-500 table-auto text-white m-4 p-2  ">
            ...
            <tbody>
              ...
              <tr className="text-white ">
                <td className="text-white p-2 border border-slate-600 ">8.</td>
                <td className="text-white p-4 border border-slate-600 ">
              ...
              <tr className="text-white ">
                <td className="text-white p-2 border border-slate-600 ">9.</td>
                <td className="text-white p-4 border border-slate-600 ">
                  Transmission Media, Telephone Line, Leased Line, Switched
                  Line, Guided Media, Unguided Media
                </td>
                <td className="text-white p-4 border border-slate-600 ">
                  <a
                    href="https://mimitbca.blogspot.com/2024/08/transmission-media-telephone-line.html"
                    className="hover:text-cyan-400"
                  >
                    Topic Link
                  </a>
              ...
              <tr className="text-white ">
                <td className="text-white p-2 border border-slate-600 ">10.</td>
                <td className="text-white p-4 border border-slate-600 ">
                  Communication switching technology
                </td>
                <td className="text-white p-4 border border-slate-600 ">
                  <a
                    href="https://mimitbca.blogspot.com/2024/08/communication-switching-technology.html"
                    className="hover:text-cyan-400"
                  >
                    Topic Link
                  </a>
              ...
              <tr className="text-white ">
                <td className="text-white p-2 border border-slate-600 ">11.</td>
                <td className="text-white p-4 border border-slate-600 ">
                  OSI (Open Systems Interconnection)
                </td>
                <td className="text-white p-4 border border-slate-600 ">
                  <a
                    href="https://mimitbca.blogspot.com/2024/08/osi-open-systems-interconnection.html"
                    className="hover:text-cyan-400"
                  >
                    Topic Link
                  </a>
              ...
              <tr className="text-white ">
                <td className="text-white p-2 border border-slate-600 ">12.</td>
                <td className="text-white p-4 border border-slate-600 ">
                  TCP/IP (Transmission Control Protocol/Internet Protocol)
                </td>
                <td className="text-white p-4 border border-slate-600 ">
                  <a
                    href="https://mimitbca.blogspot.com/2024/08/tcpip-transmission-control.html"
                    className="hover:text-cyan-400"
                  >
                    Topic Link
                  </a>
              ...
              <tr className="text-white ">
                <td className="text-white p-2 border border-slate-600 ">13.</td>
                <td className="text-white p-4 border border-slate-600 ">
                  Differences between the OSI and TCP/IP models
                </td>
                <td className="text-white p-4 border border-slate-600 ">
                  <a
                    href="https://mimitbca.blogspot.com/2024/08/aspect-osi-model-tcpip-model-number-of.html"
                    className="hover:text-cyan-400"
                  >
                    Topic Link 
                  </a>
